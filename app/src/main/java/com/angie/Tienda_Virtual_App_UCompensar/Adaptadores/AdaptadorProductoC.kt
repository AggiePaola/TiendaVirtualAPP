package com.angie.Tienda_Virtual_App_UCompensar.Adaptadores
...
import com.angie.Tienda_Virtual_App_UCompensar.Constantes
import com.angie.Tienda_Virtual_App_UCompensar.DetalleProducto.DetalleProductoActivity
import com.angie.Tienda_Virtual_App_UCompensar.Filtro.FiltroProducto
import com.angie.Tienda_Virtual_App_UCompensar.Modelos.ModeloProducto
import com.angie.Tienda_Virtual_App_UCompensar.R
import com.angie.Tienda_Virtual_App_UCompensar.databinding.ItemProductoCBinding
...
class AdaptadorProductoC : RecyclerView.Adapter<AdaptadorProductoC.HolderProducto> , Filterable{
    ...
    private fun verCarrito(modeloProducto: ModeloProducto) {
        ...
        if (!precioDesc.equals("0") && !notaDesc.equals("")){
            ...
            precioDescuentoTv.setText(precioDesc.plus(" pesos"))
            precioOriginalTv.setText(precio.plus(" pesos"))
    ...
    private fun visualizarDescuento(modeloProducto: ModeloProducto, holder: AdaptadorProductoC.HolderProducto) {
        if (!modeloProducto.precioDesc.equals("0") && !modeloProducto.notaDesc.equals("")){
            ...
            holder.item_precio_p_desc.text = "${modeloProducto.precioDesc}${" pesos"}"
            holder.item_precio_p.text = "${modeloProducto.precio}${" pesos"}"
