...
import com.angie.Tienda_Virtual_App_UCompensar.databinding.ActivityRegistroVendedorBinding
...
class RegistroVendedorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) { //registrar un vendedor
